...
abstract class AbstractSwingSplendorFrame extends JFrame {
     ...
     * @param key board key for tooltip display, for example {@code a1}
     ...
     * @return key formatted as column letter plus tier, for example {@code a1}
     */
     ...
     * @return {@code true} if the button should be clickable
     */
     ...
     * @return {@code true} when selecting this color would keep the selection valid
     */
     ...
     * @return {@code true} if a preview TAKE_TWO move validates
     */
     ...
     * @param startIndex recursion cursor into {@code colors}
     ...
     * @return {@code true} once a legal combination is found
     */
