...
/**
 * Formats player state into HTML and plain text for Swing summary panels.
 */
final class SwingPlayerSummaryFormatter {
    /**
     * Utility class; not instantiable.
     * note: recommended by chatgpt to create to prevent accidental initialisation
     */
     ...
     * @return HTML describing the player
     */
