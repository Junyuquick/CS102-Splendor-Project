...
public class Player implements Serializable {
     ...
     * @return token count for that color, or 0 if absent
     */
    ...
    /**
     * Returns the player's purchased cards.
     *
     ...
     *
     * @param card development card to reserve
     */
     ...
     *
     * @param card development card to remove
    ...
    /**
     * Returns the player's reserved cards.
     *
    ...
    /**
     * Adds a noble tile to the player's nobles.
     *
     * @param noble noble tile to add
     */
     ...
     *
     * @param bonusColor gem color bonus to count
     * @return number of cards providing this bonus
     */
     ...
     *
     * @return count of purchased development cards
     */
