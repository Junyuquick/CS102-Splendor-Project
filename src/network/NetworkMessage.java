...
public class NetworkMessage implements Serializable {
    ...
    private NetworkMessage(Type type, String playerName, Move move, GameState gameState, String errorMessage, Integer playerIndex) {
        this.type = type;
    ...
    public static NetworkMessage join(String playerName) {
        return new NetworkMessage(Type.JOIN, playerName, null, null, null, null);
    }

    public static NetworkMessage move(Move move) {
        return new NetworkMessage(Type.MOVE, null, move, null, null, null);
    }

    public static NetworkMessage stateUpdate(GameState state) {
        return new NetworkMessage(Type.STATE_UPDATE, null, null, state, null, null);
    }

    public static NetworkMessage error(String message) {
        return new NetworkMessage(Type.ERROR, null, null, null, message, null);
    }

    public static NetworkMessage gameStart(GameState initialState, int playerIndex) {
        return new NetworkMessage(Type.GAME_START, null, null, initialState, null, playerIndex);
    }

    public static NetworkMessage startRequest() {
        return new NetworkMessage(Type.START_REQUEST, null, null, null, null, null);
    }

    public static NetworkMessage disconnect() {
        return new NetworkMessage(Type.DISCONNECT, null, null, null, null, null);
    }
