...
public final class ConfigLoader {
    ...
    /**
     * Reads, validates and resolves config values from the properties file.
     *
     * @param configPath path to config file
     * @return validated configur object
    ...
    public Config load(Path configPath) throws IOException {
        ...
        return new Config(pointsToWin, maxTokensPerPlayer, maxReservedCards, maxNoblesPerTurn,
                            minPlayers, maxPlayers, numLevels, openCardsPerLevel, nobles2,
                            nobles3, nobles4, bank2, bank3, bank4, bankGold, takeDiff, takeSame,
                            takeSameMin, reserveGoldBonus, level1, level2, level3, nobles,
     ...
     * @throws IllegalArgumentException if key is missing, non numeric, or outside allowed range
     */
    ...
    /**
     * Returns required path property, resolving relative paths against config file directory.
     * 
     ...
     * @return normalized absolute or base-relative path
     */
